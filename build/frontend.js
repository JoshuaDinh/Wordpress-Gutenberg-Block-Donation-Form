...
function FormTitle() {
  ...
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("h2", null, title), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("img", {
...
const schema = yup__WEBPACK_IMPORTED_MODULE_0__["object"]().shape({
  ...
  CardNumber: yup__WEBPACK_IMPORTED_MODULE_0__["number"]().test("len", "Must be exactly 16 digits", val => !val || val && val.toString().length === 16).typeError("Looks like you forgot some numbers").nullable().required(),
  ExpiryDate: yup__WEBPACK_IMPORTED_MODULE_0__["string"]().typeError("Somethings fishy about this.").required(""),
  cvv: yup__WEBPACK_IMPORTED_MODULE_0__["number"]().test("len", "Must be exactly 3 digits", val => !val || val && val.toString().length === 3).typeError("Ooops.. Try 3 digits").required(),
  anonymous: false
});
